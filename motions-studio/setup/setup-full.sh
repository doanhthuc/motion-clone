...
JOB_TYPE="motion,bds,tryon,create-image,edit-image,product-overlay,teaser,video,text-to-video,wan-i2v,teen-flycam,trend-tiktok,ss,talk,face-motion,concat,reveal,voiceover,story-film,subtitle,enhance,character-swap,accessory-correction"
